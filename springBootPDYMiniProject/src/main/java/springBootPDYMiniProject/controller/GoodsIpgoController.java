...
import springBootPDYMiniProject.service.goodsIpgo.GoodsIpgoDeleteService;
import springBootPDYMiniProject.service.goodsIpgo.GoodsIpgoDetailService;
import springBootPDYMiniProject.service.goodsIpgo.GoodsIpgoListService;
import springBootPDYMiniProject.service.goodsIpgo.GoodsIpgoService;
import springBootPDYMiniProject.service.goodsIpgo.GoodsIpgoUpdateService;
import springBootPDYMiniProject.service.goodsIpgo.GoodsItemListService;
...
public class GoodsIpgoController {
	...
	public String goodsIpgoModify(GoodsIpgoCommand goodsIpgoCommand) {
		...
		return "redirect:goodsIpgoDetail?ipgoNum=" + goodsIpgoCommand.getGoodsIpgoNum() + "&goodsNum="
				+ goodsIpgoCommand.getGoodsNum();
	}
